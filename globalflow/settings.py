"""
Django settings for globalflow project.
...
SECRET_KEY = 'django-insecure-m!ho)6)!^lcqk#lk7f2w37b25juy499n5n38(uqv@!)ly+2rf_'
...
INSTALLED_APPS = [
    ...
    'django_filters',  # pour filtres

     # apps Django par défaut...
    'core',
    'rest_framework',  # pour API REST
...
WSGI_APPLICATION = 'globalflow.wsgi.application'
